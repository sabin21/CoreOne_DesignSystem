...
import CardActionbar01 from '../components/cards/actionbar_type01';
import CardAvatarbar01 from '../components/cards/avatarbar_type01';
...
export class CardPattern01 extends React.Component {
    render() {
        ...
        const basicCards = post1s.map((post1, index) => {
            ...
            return(
                <div className="col-12 col-sm-6 col-md-3 c1--card-basic" key={index}>
                    <div className="thumb-wrap ratio4x4" style={{backgroundImage: `url(${post1.thumbnail})`}}>
                        <span className={cx('action-wrap',{'is-active': post1.isVideo})}>
        ...
        const CardActionbar01Sample = post1s.map((post1, index) => {
            return(
                <div className="col-12 col-sm-6 col-md-4 tlc" key={index} >
                    <CardActionbar01 {...post1} />
                </div>
            );
        })
        const CardAvatarbar01Sample = post1s.map((post1, index) => {
            return(
                <div className="col-12 col-sm-6 col-md-3" key={index} >
                    <CardAvatarbar01 {...post1} />
                </div>
            );
        })
      return (
        <div className="page-wrap" style={{background: '#f7f7f7'}}>
            <div className="content-wrap">
                ...
                <div className="container">
                    ...
                    <h4 className="tiny-title">Card / Overlay</h4>
                    <div className="row">
                        {CardOverlay01Sample}
                    </div>

                    <h4 className="tiny-title">Card / Action Bar</h4>
                    <div className="row">
                        {CardActionbar01Sample}
                    </div>

                    <h4 className="tiny-title">Card / Avatar Bar</h4>
                    <div className="row">
                        {CardAvatarbar01Sample}
                    </div>
                </div>
